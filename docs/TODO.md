...
- [x] T0875 Verify rule 41: the final submission version is tagged with a documented annotated Git tag — done at submission time (2026-08-24) on explicit request: annotated tag `v1.0-submission` on main in both repos, its message recording the six counted series, the 2–3–1 record, and the 85/100 recommended self-score
